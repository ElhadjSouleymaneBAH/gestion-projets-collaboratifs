      ...
      <div class="card-body">
        ...
        <ul class="features-list">
          <li class="feature-item">
            ...
            <span>{{ $t('abonnement.fonctionnalites.gererProjets') }}</span>
          </li>
          <li class="feature-item">
            <i class="icon-check"></i>
            <span>{{ $t('abonnement.fonctionnalites.gererTaches') }}</span>
          </li>
          <li class="feature-item">
            <i class="icon-check"></i>
            <span>{{ $t('abonnement.fonctionnalites.ajouterMembres') }}</span>
          </li>
          <li class="feature-item">
            <i class="icon-check"></i>
            <span>{{ $t('abonnement.fonctionnalites.collaborationTempsReel') }}</span>
          </li>
          <li class="feature-item">
            <i class="icon-check"></i>
            <span>{{ $t('abonnement.fonctionnalites.paiementsStripe') }}</span>
          </li>
          <li class="feature-item">
            <i class="icon-check"></i>
            <span>{{ $t('abonnement.fonctionnalites.facturesPDF') }}</span>
          </li>
          <li class="feature-item">
            <i class="icon-check"></i>
          ...
          <li class="feature-item">
            <i class="icon-check"></i>
            <span>{{ $t('abonnement.fonctionnalites.multilingue') }}</span>
          </li>
        </ul>
  ...
  setup() {
    ...
    const loadNotifications = async () => {
      ...
      try {
        ...
        notifications.value = response.data.slice(0, 5)
      } catch (error) {
        console.error('Erreur chargement notifications:', error)
      }
    }

    // F10 : Initialiser paiement Stripe - CORRIGÉ
    const initializePayment = async () => {
      ...
      try {
        ...
        // CORRIGÉ : Utilisation du paramètre error
    ...
    // F10 : Traiter paiement Stripe (10€/mois) - CORRIGÉ
    ...
    // F11 : Télécharger facture - CORRIGÉ
    ...
    // Gérer abonnement (portail Stripe) - CORRIGÉ
    ...
    // F10 : Annuler abonnement - CORRIGÉ
    ...
    // Marquer notification comme lue - CORRIGÉ
...
.user-status.status-premium {
  background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
  color: white;
}

.user-status.status-standard {
  background: #f8f9fa;
  color: #6c757d;
